...
simple_rs_builder: simple_rs_builder.cpp tinyexpr.o glad.o space.o | $(LIBCDD)
	$(CXX) $(CFLAGS) $^ $(FREETYPE2_CFLAGS) -I include -L lib -o $@ $(LFLAGS)
dontdelete: simple_rs_builder.cpp tinyexpr.o glad.o space.o | $(LIBCDD)
...
tinyexpr.o: tinyexpr.c include/tinyexpr.h
	$(CC) $(CFLAGS) -c $< -I include -o $@
clean:
	$(MAKE) -C cddlib-* clean
	rm -f glad.o space.o tinyexpr.o lib/libcdd.a simple_rs_builder
